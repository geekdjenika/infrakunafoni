    ...
    return FutureBuilder<Map<String,dynamic>>(
      ...
      builder: (context, snapshot) {
        ...
        if (snapshot.hasData) {
          ...
          monuser = Utilisateur.fromJson(snapshot.data!);
          return Scaffold(
                    ...
                    child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: MediaQuery.of(context).size.height * 0.02),
                            monuser.sessionJeux!.length > 0 
                            ?
                            MyCard(
                              widget: Column(
                                children: [
                                  for(int i = 0; i < monuser.sessionJeux!.length; i++)
                                    Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Text(
                                            '${monuser.sessionJeux![i].date}',
                                            style: titreliste(background),
                                          ),
                                          Text(
                                            '${monuser.sessionJeux![i].points} points',
                                            style: titreliste(background),
                                          )
                                        ],
                                      ),
